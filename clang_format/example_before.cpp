void test()
{
    ...
    this_is_a_really_long_function(argument_one, argument_two, argument_three, argument_four, argument_five);
    ...
    abc = "this is a really huge string that really needs to be wrapped but to wrap it we need to insert extra quotation marks";
